...
public final class IO {
    ...
    public static final Joystick movementJoystick = LOG.catchAll(() -> new Joystick(IOConstants.MOVEMENT_JOYSTICK_PORT));
    public static final Joystick rotationJoystick = LOG.catchAll(() -> new Joystick(IOConstants.ROTATION_JOYSTICK_PORT));
    public static final XboxController manipulatorController = LOG.catchAll(() -> new XboxController(IOConstants.MANIPULATOR_CONTROLLER_PORT));
