...
public class OffLineSpin extends SequentialCommandGroup {
    public OffLineSpin(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, AugerSubsystem augerSubsystem) {
        PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("OffLineSpin", 3, 1);
        ...
        addCommands(
            ...
            driveSubsystem.createCommandForTrajectory(trajectory1, true).withTimeout(15).withName("OffLineSpin")
        );
    }
}