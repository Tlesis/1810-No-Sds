...
public class OffLineRight extends SequentialCommandGroup {
    public OffLineRight(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, AugerSubsystem augerSubsystem) {
        PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("OffLineR", 3, 2);
        ...
        addCommands(
            ...
            driveSubsystem.createCommandForTrajectory(trajectory1, false).withTimeout(15).withName("OffLineR")
        );
    }
}